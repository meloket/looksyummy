		...
		<div class="container">
			<div class="row">
				...
				<div style="background-color:white;">
					<h2 style="padding-left:20px;padding-top:10px; vertical-align:middle;">Privacy Policy</h2>
					...
					<p><strong>When do we collect information?</strong><br>We collect information from you when you register on our site, subscribe to a newsletter or enter information on our site.</p>
					...
					<ul class="list-group">
					<li class="list-group-item">To personalize user’s experience and to allow us to deliver the type of content and product offerings in which you are most interested.</li><li class="list-group-item">To improve our website in order to better serve you.</li><li class="list-group-item">To send periodic emails regarding your order or other products and services.</li></ul>
					...
					<ul class="list-group">
					<li class="list-group-item">Understand and save user’s preferences for future visits.</li>
					<li class="list-group-item">Compile aggregate data about site traffic and site interactions in order to offer better site experiences and tools in the future. We may also use trusted third party services that track this information on our behalf.</li>
					</ul>
					...
					<p><strong>Google</strong><br>Google’s advertising requirements can be summed up by Google’s Advertising Principles. They are put in place to provide a positive experience for users. https://support.google.com/adwordspolicy/answer/1316548?hl=en We use Google AdSense Advertising on our website.</p>
					...
					<ul class="list-group">
					<li class="list-group-item">Remarketing with Google AdSense we along with third-party vendors, such as Google use first-party cookies (such as the Google Analytics cookies) and third-party cookies (such as the DoubleClick cookie) or other third-party identifiers together to compile data regarding user interactions with ad impressions, and other ad service functions as they relate to our website..</p>
					<p><strong>Opting out:</strong><br>Users can set preferences for how Google advertises to you using the Google Ad Settings page. Alternatively, you can opt out by visiting the Network Advertising initiative opt out page or permanently using the Google Analytics Opt Out Browser add on..</p>
					...
					<p><strong>Users will be notified of any privacy policy changes:</strong></p>
					<ul class="list-group">
					<li class="list-group-item">On our Privacy Policy Page</li></ul>
					<p><strong>Users are able to change their personal information:</strong></p>
					<ul class="list-group">
					<li class="list-group-item">By emailing us</li><li class="list-group-item">By logging in to their account</li></ul>
					...
					<p><strong>CAN SPAM Act</strong><br>The CAN-SPAM Act is a law that sets the rules for commercial email, establishes requirements for commercial messages, gives recipients the right to have emails stopped from being sent to them, and spells out tough penalties for violations.<br>We collect your email address in order to:</p>
					<p>To be in accordance with CANSPAM we agree to the following:</p>
					<p>If at any time you would like to unsubscribe from receiving future emails, you can email us at<br>and we will promptly remove you from ALL correspondence.</p>
